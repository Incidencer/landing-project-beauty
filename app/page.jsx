      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row items-center h-full">
          <motion.div
            ...
            <h1 className="h1">Natural Beauty <br /> Starts Here</h1>
            <p className="lead max-w-xl mx-auto">Tailored skincare solutions for a healthy complexion, offering customized care for radiant skin</p>
          ...
          <div className="flex-1">
            <motion.div
              initial={{ opacity: 0, y: -100 }}
              animate={{ opacity: 1, y: 0, transition: { delay: 2.4, duration: 1.2, ease: 'easeInOut' }, }}
