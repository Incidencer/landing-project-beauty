                        ...
                        <div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px] mb-14 mx-auto xl:mx-0">
                                ...
                                <div className="flex-1 flex flex-col justify-center items-center xl:items-start">
                                    ...
                                    <p className="pl-6 text-[15px]">Exfoliationg treatment to improve your skin</p>
                                </div>
                                {/* end-item */}
                                {/* item */}
                                <div className="flex-1 flex flex-col justify-center items-center xl:items-start">
                                    <div className="flex items-center gap-[12px] mb-2">
                                        <div className="w-[14px] h-[14px] bg-accent rounded-tl-[28px] rounded-bl-[28px] rounded-br-[22px] rounded-tr-[4px]"></div>
                                        <h3 className="text-2xl">Eyebrow Wxing/Shaping</h3>
                                    </div>
                                    <p className="pl-6 text-[15px]">Deep cleansing, exfoliation and hydration for a refreshed complexion</p>
                                </div>
                                {/* end-item */}
                                ...
                                <div className="flex-1 flex flex-col justify-center items-center xl:items-start">
                                    ...
                                    <p className="pl-6 text-[15px]">Multi-step treatment for instant hydration and glow</p>
                                </div>
                                {/* end-item */}
                            </div>
                        </div>
