...
const CursorProvider = ({children}) => {
    ...
    const springConfig = {damping: 50, stiffness: 290, mass: 0.45}
    ...
    const mouseLeaveHandler = () => {
        setCursor ({sizer: 30, background: "#473936"});
        setIsHovering(false);
    }
    ...
    <CursorContext.Provider value={{ mouseEnterHandler, mouseLeaveHandler}}>
        <motion.div className='fixed z-[99] rounded-full pointer-events-none transition-all duration-300' style={{
            ...
            mixBlendMode: isHovering ? "differnce" : "normal",
            transition: "width 0.2 ease-in-out, height 0.2 ease-in-out"
        }} />
        {children}
